...
<head>
  ...
  <link href="../../vendor/font	<tr><td><div id="y_rpj_chart" class="chart"></div></td></tr>
						 	<tr><td><div id="y_rsales_chart" class="chart"></div></td></tr>awesome-free/css/all.min.css" rel="stylesheet" type="text/css">
