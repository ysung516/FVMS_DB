					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary"
								style="padding-left: 17px;">회의록 수정</h6>
						</div>
						...
						%>
											...
											<td colspan="4" style="padding: 0px;">
												<table id="nextPlanTable" style="width: 100%;">
													...
													<tbody>
														...
														<tr>
															<td class="firstTD"
																style="padding: 0px; border: 0px solid;"><%=nextPlanList.get(i).getNo()%></td>
															<td style="padding: 0px; border: 0px solid;"><input
																name="item<%=nextPlanList.get(i).getNo()%>"
																value="<%=nextPlanList.get(i).getItem()%>"
																style="border-radius: 0; border-top: 0px; width: 100%;"></td>
															<td style="padding: 0px; border: 0px solid;"><input
																name="deadline<%=nextPlanList.get(i).getNo()%>"
																value="<%=nextPlanList.get(i).getDeadline()%>"
																style="border-radius: 0; border-top: 0px; width: 100%;"></td>
															<td style="padding: 0px; border: 0px solid;"><input
																name="pm<%=nextPlanList.get(i).getNo()%>"
																value="<%=nextPlanList.get(i).getPM()%>"
																style="border-radius: 0; border-top: 0px; width: 100%;"></td>
															<td style="padding: 0px; border: 0px solid;"><input
																class="deleteNP" type="button" onclick="deleteNP()"
																value="삭제"
																style="border-radius: 0; border-top: 0px; width: 100%;"></td>
														</tr>
														<%} %>
										...
										<tr>
											<td colspan="4" style="border-color: #fff;"><input
												type="submit" name="complete" id="complete" value="완료"
