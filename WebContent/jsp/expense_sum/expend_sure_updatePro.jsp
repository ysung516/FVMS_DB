...
<body>
	<%
		...
		String [] value = request.getParameterValues("expend_sure");	
		...
		int [] result = expendDao.update_CostData(val[0],val[1],val[2],val[3],"expend_sure");
		if(result[0] == 1 && result[1]==1 && result[2]==1 && result[3]==1){
			script.print("<script> alert('슈어 인력 직급 단가가 변경 되었습니다. '); location.href = 'expense_sum.jsp'; </script>");
		}else{
